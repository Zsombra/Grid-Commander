# SKILLMOREL — the development pipeline this repo runs on

> Moved from the repository root on 2026-08-07: the root `README.md` now
> describes **Grid-Commander**, the product. This file documents the pipeline
> bundle in `.claude/` and `openspec/` that built it.
