...
- [ ] **T1: Add `TradeLevelPolicy` type to strategy domain**
...
- [ ] **T2: Read trade-level policy from `get_strategy` in the mapper**
...
- [ ] **T3: Carry trade-level policy through fork output mapping**
...
- [ ] **T4: Render trade-level policy on the strategy detail page**
...
- [ ] **T5: State the inert condition — no editing offered**
...
- [ ] **T6: Unit tests for the mapper and domain type**
...
- [ ] **T7: Presentation test for the policy section**
