...
**Date**: 2026-08-01  
**State**: green (961 vitest + 62 db + 221 harness tests, all nine `./scripts/ci.sh` gates; 12 further vitest are key-gated live probes). No active changes. 23 open backlog items. PRs #8–#25 merged. The assistant roadmap (`an-assistant-over-the-use-cases`) is filed; Phase 1 (strategy-maker) is underway.
...
| Changes (archived) | 69 |
| Vitest tests | 961 (+12 key-gated live) + 62 db |
| Harness tests (Python) | 221 |
| Active changes | 0 |
| Open backlog items | 23 |
| Design tickets open | 0 |
| Open draft PRs | 0 (see PR list; #8–#25 merged) |
