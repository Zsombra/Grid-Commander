...
- **Genuinely buildable, none urgent**: `recorded-signals-are-not-yet-evidence`
  ...
  `tsx-is-not-a-dependency` (#152, a one-line lite change), the open-orders slice of
