...
CATS = [
 ...
 ("Deployment policies & radar", ["get_deployment_policy","upsert_deployment_policy","delete_deployment_policy","preview_deployment_resolution","test_generate_deployment_grid","get_radar_deployment","list_radar_deployments","upsert_radar_deployment","delete_radar_deployment","preview_radar_resolution"]),
