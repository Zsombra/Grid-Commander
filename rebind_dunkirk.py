...
unused = [s for s in strats if s.get('scope') == 'PRIVATE' and s.get('isActive') and s['id'] not in used_strats]
print("Unused strategies:", [s['name'] for s in unused])

if unused:
    target_strat = unused[0]
    ...
    rebind_res = call_mcp('rebind_intelligence_agent', {
        ...
        "confirm": True,
        "idempotencyKey": "rebind-dunkirk-123"
    })
    ...
    print("No unused strategies found!")
